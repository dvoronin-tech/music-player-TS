	...
	return (
		<Routes>
			<Route path="/" element={<App token={token} />}>
				<Route
					index
					element={token ? <AuthAfterReg /> : <PreRegPage />}
				/>
				<Route
					path="/auth"
					element={token ? <AuthAfterReg /> : <Auth />}
				/>
				<Route
					path="/home"
					element={token ? <Main /> : <PreRegErrorPage />}
				/>
				{artists.map((artist) => {
					return (
						<Route
							...
							element={<Artist artistName={artist.name} />}
						/>
					);
				})}
			...
			<ThemeProvider theme={baseTheme}>
				...
				>
					{location.pathname !== '/auth' &&
						location.pathname !== '/home/fullscreen' &&
						(token ? (
							<Headers type="main" />
						) : (
							<Headers type="simple" />
				...
				{location.pathname !== '/home/fullscreen' && token && (
					<PlaySelection />
				)}
				{token && <Notification />}
				{location.pathname !== '/home/fullscreen' && token && (
				...
				{token && <AudioModule />}
				{token && location.pathname !== '/home/fullscreen' && (
					<CPLSelection />
				)}
				{token && location.pathname !== '/home/fullscreen' && (
					<AccountDataBar />
