		...
		<div className={styles.pre_reg_main}>
			<div className={styles.main_content}>
				...
				<div className={styles.content_selection}>
					<p>
						Данное приложения является “пет-проектом”, написанное с
						целью прохождения собеседования и демострации
					...
					<div className={styles.warning} id="warning">
						...
						<p>
							В приложении реализована не сложная back-end логика,
							однако никакой защиты данных кроме шифровки пароля
							на стороне сервера <span>НЕТ</span> (так как
					...
					<p>
						Следует обратить внимание на то, что я позиционирую себя
						как <b>Front-end</b> разработчик, знаний в back-end
						разработке не много, но достаточно для того, что бы
						написать не сложную серверную логику.{' '}
						<b>
							ПРИЛОЖЕНИЕ НЕ АДАПТИРОВАННО ПОД МОБИЛЬНЫЕ УСТРОЙСТВА
						</b>
